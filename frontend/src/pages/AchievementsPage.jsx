          ...
          {achievements.length > 0 ? (
            achievements.map((ach, idx) => (
              <div key={idx} className="glass border border-yellow-500/20 rounded-2xl p-6 hover:border-yellow-500/50 transition-all group hover:-translate-y-1">
                ...
                <h3 className="text-lg font-bold text-white leading-snug">{ach}</h3>
            ...
            <div className="col-span-full glass border border-slate-800/50 rounded-2xl p-12 text-center">
              <Trophy className="w-16 h-16 text-slate-600 mx-auto mb-4" />
              <h2 className="text-2xl font-bold text-white mb-2">No achievements yet</h2>
              <p className="text-slate-400 mb-6">Head over to your profile to add your first big win!</p>
